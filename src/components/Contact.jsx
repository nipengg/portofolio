    ...
    <div name="contact" className="w-full h-screen bg-[#0A192F] flex justify-center items-center p-4">
        <form method="POST" action="https://getform.io/f/c884c8a3-87b3-4913-9b31-ae66d854f226" className="flex flex-col max-w-[600px] w-full">
            <div className="pb-8">
                ...
                <p className="text-gray-300 py-4">// Submit the form below or reach me via email - <a className="underline" href="https://outlook.com/neville.tjampan@binus.ac.id">neville.tjampan@binus.ac.id</a> </p>
            </div>
